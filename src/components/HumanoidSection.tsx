...
const HumanoidSection = () => {
    ...
    const handleScroll = () => {
      if (!ticking.current) {
        ...
        window.requestAnimationFrame(() => {
          ...
          const totalScrollDistance = viewportHeight * 2; // Back to 3 cards
  ...
  return (
    <div 
      ...
      style={{ height: '300vh' }}
    >
      <section className="w-full h-screen py-4 md:py-8 sticky top-0 overflow-hidden bg-white" id="why-humanoid">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-green-500 text-white">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-gray-300 text-base md:text-lg">
                    Connect your team instantly with integrated chat, file sharing, and collaborative workspaces that keep everyone aligned.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-gray-300 text-base md:text-lg">
                    Organize projects, assign tasks, set deadlines, and monitor progress with comprehensive project management tools designed for teams.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-gray-300 text-base md:text-lg">
                    Schedule meetings, book appointments with HR and leadership, manage calendars, and integrate with all major meeting platforms.
                  </p>
                </div>
              </div>
            </div>
